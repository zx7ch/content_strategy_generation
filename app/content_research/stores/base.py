...
TypedRecordT = TypeVar(
    "TypedRecordT",
    bound=CanonicalSourceRecord
    | DirectionSourceProjectionRecord
    | DirectionalEvidencePacketRecord
    | ClaimCandidateRecord
    | ClaimAdmissionDecisionRecord
...
class ContentResearchStore(Protocol):
    ...
    def get_coverage_snapshot(
        self, workflow_run_id: str, *, version: int, execution_revision: int | None = None
    ...
    def resolve_coverage_to_execution_unit_atomically(
        self, *, snapshot: CoverageSnapshot, decision: dict[str, object]
    ...
    def save_budget_ledger_entry(
        self, record: BudgetLedgerEntryRecord
    ) -> BudgetLedgerEntryRecord: ...
    ...
    def list_human_decisions_for_workflow(
        self, workflow_run_id: str
